...
\paragraph{Q1} 
Q1. Comment on security related issues regarding the cryptographic algorithms used to
...
\paragraph{Q3}
Q3. What are the access permissions to your web server’s con?guration ?les, server certi?cate
...
\paragraph{Q4}
Q4. Web servers o?ering weak cryptography are subject to several attacks. What kind of
attacks are feasible? How did you con?gure your server to prevent such attacks?
\par
...
\paragraph{Q5}
Q5. What kind of malicious attacks is your web application (PHP) vulnerable to? Describethem briefly, and point out what countermeasures you have developed in your code to prevent such attacks.
\par
